                        ...
                        <div class="form-group">
                            ...
                            <select name="jp" class="form-control select2" required>
                                ...
                                try {
                                    ...
                                    ("SELECT `jadwalpelatihan`.`IdJadwal` as IDJ, `jenispelatihan`.`IdPel` as IDP, "
                                    ...
                                    while (res.next()) {
                                        out.println("<option value='" + res.getString("IDJ") + "'>" 
                                                + res.getString("IDJ") + " == " + res.getString("NP") + " == " + res.getString("TGP") + " == " + res.getString("W") + "</option>");
                                    }
                                    conn.close();
                                } catch (Exception e) {
                                    System.out.print(e);
                        ...
                        <%
                             try {
                                ...
                                String SQLList="SELECT `prosespelatihan`.`IdPendaftaran` AS IDPD, `prosespelatihan`.`IdUser` AS IDU, "
                                        ...
                                        + "`jadwalpelatihan`.`Waktu` AS W, `user`.`Level` AS LEV "
                                        + "FROM `jenispelatihan` "
